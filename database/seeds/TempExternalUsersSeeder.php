...
class TempExternalUsersSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('temp_external_users')->insert(['custom_id' => 'aaa', 'custom_name' => 'Don Quixote', 'custom_password' => '1234']);
        DB::table('temp_external_users')->insert(['custom_id' => 'bbb', 'custom_name' => 'Nikola Tesla', 'custom_password' => '1234']);
